...
class DataDistill(models.MultiModel):
    ...
    def model(self, lr, wd, ema, warmup_pos, consistency_weight, threshold, **kwargs):
        ...
        y2_in = tf.image.random_flip_up_down(y_in)
        y3_in = tf.image.random_flip_up_down(tf.image.random_flip_left_right(y_in))
       ...
       #TODO: handle the average ensemble and fix the type problem 
